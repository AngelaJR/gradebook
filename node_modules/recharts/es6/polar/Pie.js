  ...
  _createClass(Pie, [{
    ...
    value: function render() {
      ...
      return React.createElement(Layer, {
        ...
        clipPath: "url(#".concat(_.isNil(id) ? this.id : id, ")")
      }, this.renderSectors()), label && this.renderLabels(sectors), Label.renderCallByParent(this.props, null, false), (!isAnimationActive || prevSectors && _.isEqual(prevSectors, sectors)) && LabelList.renderCallByParent(this.props, sectors, false));
    }
  }], [{
    key: "getTextAnchor",
