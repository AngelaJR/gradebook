...
var getLabel = function getLabel(props) {
  ...
  var label = _.isNil(props.children) ? value : props.children;
...
var renderRadialLabel = function renderRadialLabel(labelProps, label, attrs) {
  ...
  var id = _.isNil(labelProps.id) ? uniqueId('recharts-radial-line-') : labelProps.id;
...
var getAttrsOfCartesianLabel = function getAttrsOfCartesianLabel(props) {
  ...
  if (_.isObject(position) && (isNumber(position.x) || isPercent(position.x)) && (isNumber(position.y) || isPercent(position.y))) {
    return {
