...
var defaultProps = {
  valueAccessor: function valueAccessor(entry) {
    return _.isArray(entry.value) ? _.last(entry.value) : entry.value;
  }
};
...
function LabelList(props) {
  ...
  return React.createElement(Layer, {
    ...
    var value = _.isNil(dataKey) ? valueAccessor(entry, index) : getValueByDataKey(entry && entry.payload, dataKey);
    var idProps = _.isNil(id) ? {} : {
      id: "".concat(id, "-").concat(index)
    };
    return React.createElement(Label, _extends({}, getPresentationAttributes(entry), others, idProps, {
      index: index,
      value: value,
      viewBox: Label.parseViewBox(_.isNil(clockWise) ? entry : _objectSpread({}, entry, {
        clockWise: clockWise
      })),
