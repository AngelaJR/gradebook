...
var isSvgElement = function isSvgElement(child) {
  return child && child.type && _.isString(child.type) && SVG_TAGS.indexOf(child.type) >= 0;
};
/**
...
export var isChildrenEqual = function isChildrenEqual(nextChildren, prevChildren) {
  ...
  if (count === 1) {
    return isSingleChildEqual(_.isArray(nextChildren) ? nextChildren[0] : nextChildren, _.isArray(prevChildren) ? prevChildren[0] : prevChildren);
  }
