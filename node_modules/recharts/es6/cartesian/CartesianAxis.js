  ...
  _createClass(CartesianAxis, [{
    ...
    value: function renderTicks(ticks) {
      ...
      var items = finalTicks.map(function (entry, i) {
        ...
        }, tickLineProps, lineCoord)), tick && _this.constructor.renderTickItem(tick, tickProps, "".concat(_.isFunction(tickFormatter) ? tickFormatter(entry.value) : entry.value).concat(unit || '')));
      });
    ...
    value: function getTicksStart(_ref2, preserveEnd) {
      ...
      if (preserveEnd) {
        ...
        var tailContent = _.isFunction(tickFormatter) ? tickFormatter(tail.value) : tail.value;
      ...
      for (var i = 0; i < count; i++) {
        var entry = result[i];
        var content = _.isFunction(tickFormatter) ? tickFormatter(entry.value) : entry.value;
