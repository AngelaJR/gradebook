...
function (_Component) {
  ...
  _createClass(Area, [{
    ...
    value: function renderAreaWithAnimation(needClip) {
      ...
      var clipPathId = _.isNil(id) ? this.id : id;
    ...
    value: function renderArea(needClip) {
      ...
      if (isAnimationActive && points && points.length && (!prevPoints && totalLength > 0 || !_.isEqual(prevPoints, points) || !_.isEqual(prevBaseLine, baseLine))) {
    ...
    value: function render() {
      ...
      return React.createElement(Layer, {
        ...
        width: width,
        height: height
      }))) : null, !hasSinglePoint ? this.renderArea(needClip) : null, (dot || hasSinglePoint) && this.renderDots(), (!isAnimationActive || isAnimationFinished) && LabelList.renderCallByParent(this.props, points));
    }
  }]);
