  ...
  function (_Component) {
    ...
    function CategoricalChartWrapper(_props) {
      ...
      _this.handleOuterEvent = function (e) {
        ...
        if (eventName && _.isFunction(_this.props[eventName])) {
          var mouse = _this.getMouseInfo(e);
      ...
      _this.tooltipTicksGenerator = function (axisMap) {
        ...
        return {
          ...
          orderedTooltipTicks: _.sortBy(tooltipTicks, function (o) {
            return o.coordinate;
          }),
          tooltipAxis: axis,
      ...
      _this.renderGrid = function (element) {
        ...
        var yAxisWithNiceTicks = Object.values(yAxisMap).find(function (axis) {
          return !_.isEmpty(axis.niceTicks);
        });
        var yAxis = yAxisWithNiceTicks || getAnyElementOfObject(yAxisMap);
      ...
      _this.uniqueChartId = _.isNil(_props.id) ? uniqueId('recharts') : _props.id;
      _this.clipPathId = "".concat(_this.uniqueChartId, "-clip");

      if (_props.throttleDelay) {
        _this.triggeredAfterMouseMove = _.throttle(_this.triggeredAfterMouseMove, _props.throttleDelay);
      }
    ...
    _createClass(CategoricalChartWrapper, [{
      ...
      value: function componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.data !== data || nextProps.width !== width || nextProps.height !== height || nextProps.layout !== layout || nextProps.stackOffset !== stackOffset || !shallowEqual(nextProps.margin, margin)) {
          ...
          var hasGlobalData = !_.isNil(nextProps.data);
      ...
      */
            ...
            if (dataKey) {
              ...
              if (type === 'category' && isCategorial) {
                ...
                if (!allowDuplicatedCategory) {
                  domain = parseDomainOfCategoryAxis(child.props.domain, domain, child).reduce(function (finalDomain, entry) {
                    return finalDomain.indexOf(entry) >= 0 || entry === '' || _.isNil(entry) ? finalDomain : _toConsumableArray(finalDomain).concat([entry]);
                  }, []);
                } else {
      ...
      value: function getFormatItems(props, currentState) {
        ...
        graphicalItems.forEach(function (item, index) {
          ...
          var maxBarSize = _.isNil(childMaxBarSize) ? globalMaxBarSize : childMaxBarSize;
