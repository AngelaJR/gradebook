...
var defaultFormatter = function defaultFormatter(value) {
  return _lodash.default.isArray(value) && (0, _DataUtils.isNumOrStr)(value[0]) && (0, _DataUtils.isNumOrStr)(value[1]) ? value.join(' ~ ') : value;
};
    ...
    value: function renderContent() {
      ...
      if (payload && payload.length) {
        ...
        var items = payload.sort(itemSorter).map(function (entry, i) {
          ...
          }, hasName ? _react.default.createElement("span", {
            className: "recharts-tooltip-item-name"
          }, entry.name) : null, hasName ? _react.default.createElement("span", {
            className: "recharts-tooltip-item-separator"
          }, separator) : null, _react.default.createElement("span", {
            className: "recharts-tooltip-item-value"
          }, finalFormatter ? finalFormatter(entry.value, entry.name, entry, i) : entry.value), _react.default.createElement("span", {
