...
var getLabel = function getLabel(props) {
  ...
  var label = _lodash.default.isNil(props.children) ? value : props.children;

  if (_lodash.default.isFunction(formatter)) {
...
var renderRadialLabel = function renderRadialLabel(labelProps, label, attrs) {
  ...
  var id = _lodash.default.isNil(labelProps.id) ? (0, _DataUtils.uniqueId)('recharts-radial-line-') : labelProps.id;
...
var getAttrsOfCartesianLabel = function getAttrsOfCartesianLabel(props) {
  ...
  if (_lodash.default.isObject(position) && ((0, _DataUtils.isNumber)(position.x) || (0, _DataUtils.isPercent)(position.x)) && ((0, _DataUtils.isNumber)(position.y) || (0, _DataUtils.isPercent)(position.y))) {
    return {
...
function Label(props) {
  ...
  if (!viewBox || _lodash.default.isNil(value) && _lodash.default.isNil(children) && !(0, _react.isValidElement)(content) && !_lodash.default.isFunction(content)) {
    return null;
  }
  ...
  if (_lodash.default.isFunction(content)) {
    label = content(props);
...
var parseLabel = function parseLabel(label, viewBox) {
  ...
  if ((0, _react.isValidElement)(label) || _lodash.default.isFunction(label)) {
    return _react.default.createElement(Label, {
      key: "label-implicit",
      content: label,
      viewBox: viewBox
  ...
  if (_lodash.default.isObject(label)) {
