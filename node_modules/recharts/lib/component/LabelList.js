...
var defaultProps = {
  valueAccessor: function valueAccessor(entry) {
    return _lodash.default.isArray(entry.value) ? _lodash.default.last(entry.value) : entry.value;
  }
};
...
function LabelList(props) {
  ...
  return _react.default.createElement(_Layer.default, {
    ...
    var value = _lodash.default.isNil(dataKey) ? valueAccessor(entry, index) : (0, _ChartUtils.getValueByDataKey)(entry && entry.payload, dataKey);
    var idProps = _lodash.default.isNil(id) ? {} : {
    ...
    return _react.default.createElement(_Label.default, _extends({}, (0, _ReactUtils.getPresentationAttributes)(entry), others, idProps, {
      index: index,
      value: value,
      viewBox: _Label.default.parseViewBox(_lodash.default.isNil(clockWise) ? entry : _objectSpread({}, entry, {
        clockWise: clockWise
      })),
...
var parseLabelList = function parseLabelList(label, data) {
  ...
  if (_react.default.isValidElement(label) || _lodash.default.isFunction(label)) {
    return _react.default.createElement(LabelList, {
      key: "labelList-implicit",
      data: data,
      content: label
