...
var Pie = (0, _PureRender.default)(_class = (_temp = _class2 =
/*#__PURE__*/
function (_Component) {
  ...
  _createClass(Pie, [{
    ...
    value: function renderLabels(sectors) {
      ...
      var labels = sectors.map(function (entry, i) {
        ...
        if (_lodash.default.isNil(dataKey) && _lodash.default.isNil(valueKey)) {
          realDataKey = 'value';
        } else if (_lodash.default.isNil(dataKey)) {
    ...
    value: function renderSectors() {
      ...
      if (isAnimationActive && sectors && sectors.length && (!prevSectors || !_lodash.default.isEqual(prevSectors, sectors))) {
    ...
    value: function render() {
      ...
      return _react.default.createElement(_Layer.default, {
        ...
        clipPath: "url(#".concat(_lodash.default.isNil(id) ? this.id : id, ")")
      }, this.renderSectors()), label && this.renderLabels(sectors), _Label.default.renderCallByParent(this.props, null, false), (!isAnimationActive || prevSectors && _lodash.default.isEqual(prevSectors, sectors)) && _LabelList.default.renderCallByParent(this.props, sectors, false));
    }
  }], [{
    key: "getTextAnchor",
    ...
    value: function renderLabelLineItem(option, props) {
      ...
      if (_lodash.default.isFunction(option)) {
        return option(props);
      }
    ...
    value: function renderSectorItem(option, props) {
      ...
      if (_lodash.default.isPlainObject(option)) {
  ...
  return Pie;
}(_react.Component), _class2.displayName = 'Pie', _class2.propTypes = _objectSpread({}, _ReactUtils.PRESENTATION_ATTRIBUTES, _ReactUtils.EVENT_ATTRIBUTES, {
