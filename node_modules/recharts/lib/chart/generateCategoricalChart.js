...
var generateCategoricalChart = function generateCategoricalChart(_ref) {
  ...
  function (_Component) {
    ...
    function CategoricalChartWrapper(_props) {
      ...
      _this.handleReceiveSyncEvent = function (cId, chartId, data) {
        ...
        if (syncId === cId && chartId !== _this.uniqueChartId) {
          ...
          if (!_lodash.default.isNil(data.dataStartIndex) || !_lodash.default.isNil(data.dataEndIndex)) {
          ...
          } else if (!_lodash.default.isNil(data.activeTooltipIndex)) {
      ...
      _this.handleMouseEnter = function (e) {
        ...
        if (mouse) {
          ...
          if (_lodash.default.isFunction(onMouseEnter)) {
      ...
      _this.triggeredAfterMouseMove = function (e) {
        ...
        if (_lodash.default.isFunction(onMouseMove)) {
      ...
      _this.handleMouseMove = function (e) {
        if (e && _lodash.default.isFunction(e.persist)) {
          e.persist();
        }
      ...
      _this.handleMouseLeave = function (e) {
        ...
        if (_lodash.default.isFunction(onMouseLeave)) {
      ...
      _this.handleOuterEvent = function (e) {
        ...
        if (eventName && _lodash.default.isFunction(_this.props[eventName])) {
          var mouse = _this.getMouseInfo(e);
      ...
      _this.handleMouseDown = function (e) {
        ...
        if (_lodash.default.isFunction(onMouseDown)) {
          var mouse = _this.getMouseInfo(e);
      ...
      _this.handleMouseUp = function (e) {
        ...
        if (_lodash.default.isFunction(onMouseUp)) {
          var mouse = _this.getMouseInfo(e);
      ...
      _this.tooltipTicksGenerator = function (axisMap) {
        ...
        return {
          ...
          orderedTooltipTicks: _lodash.default.sortBy(tooltipTicks, function (o) {
            return o.coordinate;
          }),
          tooltipAxis: axis,
      ...
      _this.renderGrid = function (element) {
        ...
        var yAxisWithNiceTicks = Object.values(yAxisMap).find(function (axis) {
          return !_lodash.default.isEmpty(axis.niceTicks);
        });
        var yAxis = yAxisWithNiceTicks || (0, _DataUtils.getAnyElementOfObject)(yAxisMap);
      ...
      _this.renderGraphicChild = function (element, displayName, index) {
        ...
        if (hasActive) {
          ...
          if (tooltipAxis.dataKey && !tooltipAxis.allowDuplicatedCategory) {
            activePoint = (0, _DataUtils.findEntryInArray)(points, "payload.".concat(tooltipAxis.dataKey), activeLabel);
            basePoint = isRange && baseLine && (0, _DataUtils.findEntryInArray)(baseLine, "payload.".concat(tooltipAxis.dataKey), activeLabel);
          } else {
            activePoint = points[activeTooltipIndex];
            basePoint = isRange && baseLine && baseLine[activeTooltipIndex];
          }

          if (!_lodash.default.isNil(activePoint)) {
      ...
      _this.uniqueChartId = _lodash.default.isNil(_props.id) ? (0, _DataUtils.uniqueId)('recharts') : _props.id;
      _this.clipPathId = "".concat(_this.uniqueChartId, "-clip");

      if (_props.throttleDelay) {
        _this.triggeredAfterMouseMove = _lodash.default.throttle(_this.triggeredAfterMouseMove, _props.throttleDelay);
      }
    ...
    _createClass(CategoricalChartWrapper, [{
      ...
      value: function componentDidMount() {
        if (!_lodash.default.isNil(this.props.syncId)) {
          this.addListener();
        }
      }
    }, {
      ...
      value: function componentWillReceiveProps(nextProps) {
        ...
        if (nextProps.data !== data || nextProps.width !== width || nextProps.height !== height || nextProps.layout !== layout || nextProps.stackOffset !== stackOffset || !(0, _PureRender.shallowEqual)(nextProps.margin, margin)) {
          ...
          var hasGlobalData = !_lodash.default.isNil(nextProps.data);
        ...
        if (_lodash.default.isNil(this.props.syncId) && !_lodash.default.isNil(nextProps.syncId)) {
          this.addListener();
        } // remove syncId
      ...
      */
            ...
            if (dataKey) {
              ...
              if (type === 'category' && isCategorial) {
                ...
                if (allowDuplicatedCategory && duplicate) {
                  ...
                  domain = _lodash.default.range(0, len);
                ...
                if (!allowDuplicatedCategory) {
                  domain = (0, _ChartUtils.parseDomainOfCategoryAxis)(child.props.domain, domain, child).reduce(function (finalDomain, entry) {
                    return finalDomain.indexOf(entry) >= 0 || entry === '' || _lodash.default.isNil(entry) ? finalDomain : _toConsumableArray(finalDomain).concat([entry]);
                  }, []);
                } else {
                  // eliminate undefined or null or empty string
                  domain = domain.filter(function (entry) {
                    return entry !== '' && !_lodash.default.isNil(entry);
                  });
                }
              } else if (type === 'number') {
      ...
      value: function getTooltipContent(activeIndex, activeLabel) {
        ...
        return graphicalItems.reduce(function (result, child) {
          ...
          return _toConsumableArray(result).concat([_objectSpread({}, (0, _ReactUtils.getPresentationAttributes)(child), {
            dataKey: dataKey,
            unit: unit,
            formatter: formatter,
            name: name || dataKey,
      ...
      value: function getFormatItems(props, currentState) {
        ...
        graphicalItems.forEach(function (item, index) {
          ...
          var maxBarSize = _lodash.default.isNil(childMaxBarSize) ? globalMaxBarSize : childMaxBarSize;
      ...
      value: function getCursorPoints() {
        ...
        } else if (!_lodash.default.isNil(activeCoordinate.cx) || !_lodash.default.isNil(activeCoordinate.cy)) {
          if (layout === 'centric') {
      ...
      value: function triggerSyncEvent(data) {
        ...
        if (!_lodash.default.isNil(syncId)) {
      ...
      value: function renderClipPath() {
        ...
        return _react.default.createElement("clipPath", {
          id: clipPathId
      ...
      value: function renderActiveDot(option, props) {
        ...
        } else if (_lodash.default.isFunction(option)) {
          dot = option(props);
        } else {
  ...
  CategoricalChartWrapper.createDefaultState = function (props) {
    ...
    return {
      ...
      isTooltipActive: !_lodash.default.isNil(defaultShowTooltip) ? defaultShowTooltip : false
    };
  };
