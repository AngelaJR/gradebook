...
var Scatter = (0, _PureRender.default)(_class = (_temp = _class2 =
/*#__PURE__*/
function (_Component) {
  ...
  _createClass(Scatter, [{
    ...
    value: function renderSymbols() {
      ...
      if (isAnimationActive && points && points.length && (!prevPoints || !_lodash.default.isEqual(prevPoints, points))) {
    ...
    value: function renderLine() {
      ...
      } else if (_lodash.default.isFunction(line)) {
  ...
  return Scatter;
}(_react.Component), _class2.displayName = 'Scatter', _class2.propTypes = _objectSpread({}, _ReactUtils.EVENT_ATTRIBUTES, _ReactUtils.PRESENTATION_ATTRIBUTES, {
  ...
  var xAxisDataKey = _lodash.default.isNil(xAxis.dataKey) ? item.props.dataKey : xAxis.dataKey;
  var yAxisDataKey = _lodash.default.isNil(yAxis.dataKey) ? item.props.dataKey : yAxis.dataKey;
  ...
  var points = displayedData.map(function (entry, index) {
    ...
    var z = !_lodash.default.isNil(zAxisDataKey) && entry[zAxisDataKey] || '-';
    var tooltipPayload = [{
