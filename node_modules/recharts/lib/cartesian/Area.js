...
var Area = (0, _PureRender.default)(_class = (_temp = _class2 =
/*#__PURE__*/
function (_Component) {
  ...
  function Area() {
    ...
    _this.handleAnimationEnd = function () {
      ...
      if (_lodash.default.isFunction(onAnimationEnd)) {
        onAnimationEnd();
      }
    };
    ...
    _this.handleAnimationStart = function () {
      ...
      if (_lodash.default.isFunction(onAnimationStart)) {
        onAnimationStart();
      }
    };
  ...
  _createClass(Area, [{
    ...
    value: function renderHorizontalRect(alpha) {
      ...
      } else if (baseLine && _lodash.default.isArray(baseLine) && baseLine.length) {
    ...
    value: function renderAreaStatically(points, baseLine, needClip) {
      ...
      return _react.default.createElement(_Layer.default, {
        clipPath: needClip ? "url(#clipPath-".concat(this.id, ")") : null
    ...
    value: function renderAreaWithAnimation(needClip) {
      ...
      var clipPathId = _lodash.default.isNil(id) ? this.id : id;
      return _react.default.createElement(_reactSmooth.default, {
        ...
        if (prevPoints) {
          ...
          } else if (_lodash.default.isNil(baseLine) || _lodash.default.isNaN(baseLine)) {
    ...
    value: function renderArea(needClip) {
      ...
      if (isAnimationActive && points && points.length && (!prevPoints && totalLength > 0 || !_lodash.default.isEqual(prevPoints, points) || !_lodash.default.isEqual(prevBaseLine, baseLine))) {
    ...
    value: function render() {
      ...
      return _react.default.createElement(_Layer.default, {
        ...
        width: width,
        height: height
      }))) : null, !hasSinglePoint ? this.renderArea(needClip) : null, (dot || hasSinglePoint) && this.renderDots(), (!isAnimationActive || isAnimationFinished) && _LabelList.default.renderCallByParent(this.props, points));
    }
  }]);

  return Area;
}(_react.Component), _class2.displayName = 'Area', _class2.propTypes = _objectSpread({}, _ReactUtils.PRESENTATION_ATTRIBUTES, _ReactUtils.EVENT_ATTRIBUTES, {
  ...
  var points = displayedData.map(function (entry, index) {
    ...
    if (layout === 'horizontal') {
      return {
        ...
        y: _lodash.default.isNil(value[1]) ? null : yAxis.scale(value[1]),
        value: value,
        payload: entry
      };
    }
    ...
    return {
      x: _lodash.default.isNil(value[1]) ? null : xAxis.scale(value[1]),
  ...
  if (hasStack || isRange) {
    baseLine = points.map(function (entry) {
      if (layout === 'horizontal') {
        return {
          x: entry.x,
          y: !_lodash.default.isNil(_lodash.default.get(entry, 'value[0]')) ? yAxis.scale(_lodash.default.get(entry, 'value[0]')) : null
        };
      }

      return {
        x: !_lodash.default.isNil(_lodash.default.get(entry, 'value[0]')) ? xAxis.scale(_lodash.default.get(entry, 'value[0]')) : null,
        y: entry.y
      };
    });
