...
var Line = (0, _PureRender.default)(_class = (_temp = _class2 =
/*#__PURE__*/
function (_Component) {
  ...
  _createClass(Line, [{
    ...
    value: function renderCurve(needClip, clipPathId) {
      ...
      if (isAnimationActive && points && points.length && (!prevPoints && totalLength > 0 || !_lodash.default.isEqual(prevPoints, points))) {
  ...
  return Line;
}(_react.Component), _class2.displayName = 'Line', _class2.propTypes = _objectSpread({}, _ReactUtils.PRESENTATION_ATTRIBUTES, _ReactUtils.EVENT_ATTRIBUTES, {
  ...
  var points = displayedData.map(function (entry, index) {
    ...
    if (layout === 'horizontal') {
      return {
        ...
        y: _lodash.default.isNil(value) ? null : yAxis.scale(value),
        value: value,
        payload: entry
      };
    }
    ...
    return {
      x: _lodash.default.isNil(value) ? null : xAxis.scale(value),
