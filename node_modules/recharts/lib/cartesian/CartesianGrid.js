...
function (_Component) {
  ...
  _createClass(CartesianGrid, [{
    ...
    value: function render() {
      ...
      if ((!horizontalPoints || !horizontalPoints.length) && _lodash.default.isFunction(horizontalCoordinatesGenerator)) {
      ...
      if ((!verticalPoints || !verticalPoints.length) && _lodash.default.isFunction(verticalCoordinatesGenerator)) {
