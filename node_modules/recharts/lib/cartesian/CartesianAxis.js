  ...
  _createClass(CartesianAxis, [{
    ...
    value: function renderTicks(ticks) {
      ...
      var items = finalTicks.map(function (entry, i) {
        ...
        }, tickLineProps, lineCoord)), tick && _this.constructor.renderTickItem(tick, tickProps, "".concat(_lodash.default.isFunction(tickFormatter) ? tickFormatter(entry.value) : entry.value).concat(unit || '')));
      });
    ...
    value: function render() {
      ...
      if (_lodash.default.isFunction(ticksGenerator)) {
    ...
    value: function getTicksStart(_ref2, preserveEnd) {
      ...
      if (preserveEnd) {
        ...
        var tailContent = _lodash.default.isFunction(tickFormatter) ? tickFormatter(tail.value) : tail.value;
      ...
      for (var i = 0; i < count; i++) {
        var entry = result[i];
        var content = _lodash.default.isFunction(tickFormatter) ? tickFormatter(entry.value) : entry.value;
