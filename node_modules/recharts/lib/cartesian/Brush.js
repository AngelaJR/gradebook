...
var Brush = (0, _PureRender.default)(_class = (_temp = _class2 =
/*#__PURE__*/
function (_Component) {
  ...
  _createClass(Brush, [{
    ...
    value: function getTextOfTick(index) {
      ...
      return _lodash.default.isFunction(tickFormatter) ? tickFormatter(text) : text;
    }
  }, {
    key: "handleSlideDrag",
    ...
    value: function updateScale(props) {
      ...
      var len = data.length;
      this.scale = (0, _d3Scale.scalePoint)().domain(_lodash.default.range(0, len)).range([x, x + width - travellerWidth]);
      this.scaleValues = this.scale.domain().map(function (entry) {
