...
function () {
  ...
  function LabeledScaleHelper(scales) {
    ...
    this.scales = _lodash.default.mapValues(scales, ScaleHelper.create);
  ...
  _createClass(LabeledScaleHelper, [{
    ...
    value: function apply(coords) {
      ...
      return _lodash.default.mapValues(coords, function (value, label) {
    ...
    value: function isInRange(coords) {
      var scales = this.scales;
      return _lodash.default.every(coords, function (value, label) {
