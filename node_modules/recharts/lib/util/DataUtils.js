...
var isPercent = function isPercent(value) {
  return _lodash.default.isString(value) && value.indexOf('%') === value.length - 1;
};

exports.isPercent = isPercent;

var isNumber = function isNumber(value) {
  return _lodash.default.isNumber(value) && !_lodash.default.isNaN(value);
};

exports.isNumber = isNumber;

var isNumOrStr = function isNumOrStr(value) {
  return isNumber(value) || _lodash.default.isString(value);
};
...
var getPercentValue = function getPercentValue(percent, totalValue) {
  ...
  if (!isNumber(percent) && !_lodash.default.isString(percent)) {
    return defaultValue;
  }
...
var findEntryInArray = function findEntryInArray(ary, specifiedKey, specifiedValue) {
  ...
  return ary.find(function (entry) {
    return entry && _lodash.default.get(entry, specifiedKey) === specifiedValue;
  });
};
/**
